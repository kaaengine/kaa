...
.. code-block:: python
    ...
    def __init__(self):
        super().__init__()
        arrow_sprite = Sprite(os.path.join('assets', 'gfx', 'arrow.png'))
        self.arrow1 = Node(sprite=arrow_sprite, position=Vector(200, 200))
        self.arrow2 = Node(sprite=arrow_sprite, position=Vector(400, 300))
        self.arrow3 = Node(sprite=arrow_sprite, position=Vector(600, 500))
...
.. code-block:: python
    ...
    def __init__(self):
        super().__init__()
        arrow_sprite = Sprite(os.path.join('assets', 'gfx', 'arrow.png'))
        self.arrow1 = Node(sprite=arrow_sprite, position=Vector(200, 200))  # note: default position is Vector(0, 0)
        self.arrow2 = Node(sprite=arrow_sprite, position=Vector(400, 300))
        self.arrow3 = Node(sprite=arrow_sprite, position=Vector(600, 500))
...
.. code-block:: python
    ...
    def __init__(self):
        ...
        pixel_marker_sprite = Sprite(os.path.join('assets', 'gfx', 'pixel-marker.png'))
        # create pixel_marker 1 in the same spot as arrow2 (but with bigger z-index so we can see it)
        self.pixel_marker1 = Node(sprite=pixel_marker_sprite, position=Vector(400, 300), z_index=100)
        # create pixel_marker 2 in the same spot as arrow3
        self.pixel_marker2 = Node(sprite=pixel_marker_sprite, position=Vector(600, 500), z_index=100)
...
Re-run the game and see how arrow3 is now drawn in a different place, without changing its position, just its
...
.. code-block:: python
    ...
    def __init__(self):
        # .... previous code .....
        green_arrow_sprite = Sprite(os.path.join('assets', 'gfx', 'arrow-green.png'))
        self.child_arrow1 = Node(sprite=green_arrow_sprite, position=Vector(0,0), rotation_degrees=90, z_index=1)
...
Take some time to experiment with the parent-child system. Try changing both nodes properties such as position,
...
If you need to hide or show a node explicitly, use :code:`visible` property:
...
Deleting objects manually from the scene
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
