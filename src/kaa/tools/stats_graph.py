...
class Graph:
    def __init__(self, data_queue: queue.Queue,
                 subplot_patterns):
        self.data_queue = data_queue
        self.subplot_patterns = subplot_patterns

        needed_subplots_count = len(self.subplot_patterns) + 1
        ...
        self.pattern_subplots_map = {
            pattern: ax for pattern, ax in zip(self.subplot_patterns, other_axes)
        }
